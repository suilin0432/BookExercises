...
% When we have more points, the feature of the sample datas becomes closer
% to the feature of the pdf curve, so one point should have less
% contribution to further data points than before.
